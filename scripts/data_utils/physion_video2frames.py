...
training_train_task2path = load_obj(
    'slotdiffusion/video_based/datasets/splits/Physion/training_train.json')
training_val_task2path = load_obj(
    'slotdiffusion/video_based/datasets/splits/Physion/training_val.json')
readout_train_task2path = load_obj(
    'slotdiffusion/video_based/datasets/splits/Physion/readout_train.json')
readout_val_task2path = load_obj(
    'slotdiffusion/video_based/datasets/splits/Physion/readout_val.json')
test_task2path = load_obj(
    'slotdiffusion/video_based/datasets/splits/Physion/test_test.json')
